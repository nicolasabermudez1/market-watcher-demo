...
ACTIVITY_LIBRARY: dict[str, list[tuple[str, str]]] = {
    "scan": [
        ...
        ("🌐", "Scanning Bloomberg, Reuters, FT, The Register for vendor news..."),
        ("🌐", "Cross-referencing Dun & Bradstreet financial risk scores..."),
        ("🧾", "Loading Ecovadis sustainability scorecards for 8 PSL vendors..."),
        ...
        ("📰", "Aggregating analyst notes from Achilles, Killies, Credit Watch..."),
        ("⚠️", "Flagging contracts expiring within 90 days..."),
        ("🧠", "Synthesising findings with Gemini 2.5 Flash..."),
        ("📝", "Drafting Centrica-branded weekly digest..."),
        ("✅", "Digest ready."),
    ],
    "dashboard": [
